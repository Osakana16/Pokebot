...
#define POKEBOT_ENUM_BIT_OPERATORS(TYPE) inline TYPE operator|(const TYPE& n1, const TYPE& n2) noexcept { return static_cast<TYPE>((int)n1 | (int)n2); } inline TYPE operator&(const TYPE& n1, const TYPE& n2) noexcept { return static_cast<TYPE>((int)n1 & (int)n2); } inline TYPE operator^(const TYPE& n1, const TYPE& n2) noexcept { return static_cast<TYPE>((int)n1 ^ (int)n2); } inline TYPE operator|=(TYPE& n1, const TYPE& n2) noexcept { n1 = (n1 | n2); return n1; } inline TYPE operator&=(TYPE& n1, const TYPE& n2) noexcept { n1 = (n1 & n2); return n1; } inline TYPE operator^=(TYPE& n1, const TYPE& n2) noexcept { n1 = (n1 ^ n2); return n1; } inline TYPE operator~(TYPE n1) noexcept { return static_cast<TYPE>(~static_cast<int>(n1)); }
